...
python main.py --env-name %env% --algo ppo --use-gae --lr 2e-4 --clip-param 0.1 --value-loss-coef 0.5 --num-processes %num_proc% --num-steps 1024 --num-mini-batch 16 --log-interval 1 --use-linear-lr-decay --entropy-coef 0.01 --save-dir "save" --save-interval 5 --gamma 0.99 --gae-lambda 0.95 --ppo-epoch 4 --eval-interval 5