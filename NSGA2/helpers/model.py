...
from helpers.distributions import Bernoulli, Categorical, DiagGaussian
from helpers.utils import init
    ...
    def __init__(self, num_inputs, is_genesis=False, recurrent=False, hidden_size=512):
        ...
        if(is_genesis):
            ...
            self.main = nn.Sequential(
                ...
                init_(nn.Conv2d(32, 64, 4, stride=2)), nn.ReLU(),           # 20 x 20 input
                init_(nn.Conv2d(64, 32, 3, stride=1)), nn.ReLU(), Flatten(),# 9 x 9 input
                init_(nn.Linear(32 * 7 * 7, hidden_size)), nn.ReLU())       # 7 x 7 per channel
